...
import com.cazares.miguel.user_post.util.StringUtil;
...
public class ReactNativeActivityBase extends AppCompatActivity implements DefaultHardwareBackBtnHandler {
    ...
    protected void setAppName(String appName) {
        ...
        String dashCaseAppName = StringUtil.camelCaseToDashCase(appName);
